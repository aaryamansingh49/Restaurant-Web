...
import CakeData from '../Dishes/CakeData';
...
const App = () => {
  ...
  const [filteredItems, setFilteredItems] = useState(CakeData);
  ...
  const handleCategorySelect = (category) => {
    ...
    switch (category) {
      case "Recommended":
        newFilteredItems = CakeData;
        break;
      case "Veg Pizza ":
        newFilteredItems = CakeData.filter(
          (item) => item.category === "Veg Pizza "
        );
        break;
      case "Non Veg Pizza ":
        newFilteredItems = CakeData.filter(
          (item) => item.category === "Non Veg Pizza "
        );
        break;
      case "Pasta ":
        newFilteredItems = CakeData.filter(
        ...
        break;
        deafult: newFilteredItems = CakeData;
    }
